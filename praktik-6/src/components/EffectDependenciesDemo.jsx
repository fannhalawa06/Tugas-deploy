  ...
  return (
    <div className="dependencies-demo">
      ...
      <div className="explanation">
        ...
        <ul>
          <li>
            <strong>No dependencies</strong> - Run setelah setiap render
          </li>
          <li>
            <strong>[]</strong> - Run sekali setelah mount
          </li>
          <li>
            <strong>[count]</strong> - Run ketika count berubah
          </li>
          <li>
            <strong>[name]</strong> - Run ketika name berubah
          </li>
          <li>
            <strong>[count, name]</strong> - Run ketika count ATAU name berubah
          </li>
        </ul>
      </div>
